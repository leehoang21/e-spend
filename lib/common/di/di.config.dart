...
import '../../domain/use_cases/statistic_use_case.dart' as _i39;
import '../../domain/use_cases/storage_use_case.dart' as _i17;
import '../../domain/use_cases/transaction_use_case.dart' as _i42;
...
import '../../presentation/journey/account/auth_setting/cubit/auth_settings_cubit.dart'
    as _i46;
import '../../presentation/journey/account/cubit/account_cubit.dart' as _i45;
...
import '../../presentation/journey/auth/verify_otp/cubit/verify_cubit.dart'
    as _i43;
import '../../presentation/journey/home/cubit/home_cubit.dart' as _i48;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i38.SettingsCubit>(() => _i38.SettingsCubit(
          gh<_i9.HiveConfig>(),
          gh<_i31.AuthUseCase>(),
        ));
    gh.factory<_i39.StatisticUseCase>(
        () => _i39.StatisticUseCase(gh<_i13.StatisticsRepository>()));
    gh.factory<_i40.TransactionRepository>(() => _i41.TransactionRepositoryImpl(
          gh<_i8.FirebaseConfig>(),
          gh<_i26.WalletRepository>(),
          gh<_i15.StorageRepository>(),
        ));
    gh.factory<_i42.TransactionUseCase>(() => _i42.TransactionUseCase(
          gh<_i40.TransactionRepository>(),
          gh<_i13.StatisticsRepository>(),
          gh<_i15.StorageRepository>(),
        ));
    gh.factory<_i43.VerifyCubit>(() => _i43.VerifyCubit(
          gh<_i31.AuthUseCase>(),
          gh<_i22.UserUseCase>(),
          gh<_i9.HiveConfig>(),
        ));
    gh.factory<_i44.WalletListCubit>(
        () => _i44.WalletListCubit(gh<_i28.WalletUseCase>()));
    gh.factory<_i45.AccountCubit>(() => _i45.AccountCubit(
          gh<_i9.HiveConfig>(),
          gh<_i31.AuthUseCase>(),
        ));
    gh.factory<_i46.AuthSettingsCubit>(() => _i46.AuthSettingsCubit(
          gh<_i9.HiveConfig>(),
          gh<_i31.AuthUseCase>(),
          gh<_i4.BiometricConfig>(),
        ));
    gh.factory<_i47.CreateTransactionBloc>(() => _i47.CreateTransactionBloc(
          gh<_i42.TransactionUseCase>(),
          gh<_i17.StorageUseCase>(),
        ));
    gh.factory<_i48.HomeCubit>(() => _i48.HomeCubit(
          gh<_i42.TransactionUseCase>(),
          gh<_i22.UserUseCase>(),
          gh<_i39.StatisticUseCase>(),
          gh<_i19.TimeCubit>(),
        ));
    gh.factory<_i49.StatisticCubit>(() => _i49.StatisticCubit(
          gh<_i39.StatisticUseCase>(),
          gh<_i22.UserUseCase>(),
          gh<_i19.TimeCubit>(),
        ));
    gh.factory<_i50.TransactionListCubit>(
        () => _i50.TransactionListCubit(gh<_i42.TransactionUseCase>()));
    return this;
  }
}
